    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md">
        ...
        <AnimatePresence mode="wait">
          {!isOrderComplete ? (
            <motion.div key="checkout" className="space-y-6" initial={{ opacity: 1 }} exit={{ opacity: 0 }}>
              ...
              <div className="space-y-2">
                ...
                <div ref={sliderRef} className="relative h-16 bg-gray-100 rounded-full overflow-hidden shadow-inner">
                  <div className="absolute inset-0 bg-gradient-to-r from-green-400 to-green-500 opacity-50" />
                  <motion.div
                    drag="x"
                  ...
                  >
                    <ArrowRight
                      className={`w-6 h-6 ${isDragging ? "text-green-600" : "text-gray-400"} transition-colors`}
                    />
                  </motion.div>
