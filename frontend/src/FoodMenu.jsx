...
const FoodMenu = () => {
    ...
    return (
        <div className="px-4 lg:px-20 py-10 min-h-screen">
            {/* Search Bar */}
            <div className="mb-6 sticky top-0 z-10 bg-white bg-opacity-90 backdrop-blur-md p-4 rounded-lg shadow-md">
            ...
            <div className="lg:hidden sticky top-20 z-10 -mx-4 px-4 py-2 bg-white bg-opacity-90 backdrop-blur-md shadow-sm">
                <div className="flex overflow-x-auto hide-scrollbar gap-2 pb-2">
                    {menuCategories.map((category) => (
                        <Button
                            ...
                            className={`flex-shrink-0 whitespace-nowrap ${activeCategory === category.id
            ...
            <div className="hidden lg:flex flex-col lg:flex-row gap-6">
                ...
                <div className="lg:w-1/5">
                    <div className="sticky top-24 bg-white p-4 border-r rounded-lg shadow-sm">
                                ...
                                <div className="space-y-2">
                                    {menuCategories.map((category) => (
                                        <motion.div
                                            ...
                                            className="py-2 px-3 rounded-md hover:bg-orange-100 cursor-pointer"
